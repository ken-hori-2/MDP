...
class Anim():
    ...
    def __init__(self):
        ...
        self.state_history = [[3], [2], [1], [0], [1], [2], [3], [2], [1], [0], [1], [2], [3]] # [[3], [2], [1], [0], [1], [2], [3], [4]]
    ...
    def view_plot_text(self):
        ...
        plt.plot([0.5, 0.5], [1.5, 7.5], color="black")
