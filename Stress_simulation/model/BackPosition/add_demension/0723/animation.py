...
class Anim():
    ...
    def __init__(self):
        ...
        # 110000, 111000
        self.state_history = [0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 0, 0]
        # self.state_history = [0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 5, 2, 2, 0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 5, 2, 2, 0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 5, 2, 2, 0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 5, 2, 2, 0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 5, 2, 2, 0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 5, 2, 2, 0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 5, 2, 2, 0, 0, 1, 1, 2, 2, 3, 4, 5, 5]
        self.state_history = [0, 0, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1, 1, 1, 2, 3, 4, 4, 4, 1, 1]
        self.state_history = [0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5, 2, 2, 2, 2, 3, 4, 5, 5, 5]
        # 110100
        self.state_history = [0, 0, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1]
        # self.state_history = [0, 0, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 0, 0, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 0, 0, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 0, 0, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 0, 0, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 0, 0, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 0, 0, 1, 1, 2]
        self.state_history = [0, 0, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 1, 1, 2, 3, 3, 4, 5, 5, 5, 3, 3, 3, 1, 1, 1]
    ...
    def view_anim(self): #　初期化関数とフレームごとの描画関数を用いて動画を作成する
        self.anim = animation.ArtistAnimation(self.fig, self.ims, interval=500, repeat = True)
        plt.show()
        return True
